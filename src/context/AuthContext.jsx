 ...
 *
 * NOTE: X/Twitter login has been removed from the frontend flow.
 * The backend routes (/api/auth/x/login, /api/auth/x/callback) can
 * stay as-is or be removed separately — this file just no longer
 * calls them.
 *
 * Wrap your app once:
 *   <AuthProvider>
